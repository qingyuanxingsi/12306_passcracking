...
<a name="Markov"></a>[Fast Dictionary Attacks on Passwords Using Time-Space Tradeoff](#Markov) by A. Narayanan (CCS 2005)
[Password Cracking Using Probabilistic Context-Free Grammars](#PCFG) by M. Weir (S&P 2009)
<a name = "AdaptMeter"></a>[Adaptive Password-Strength Meters from Markov Models](#AdaptMeter) by C. Casterlluccia (NDSS 2012)
<a name="OMEN"></a>[When Privacy meets Security: Leveraging Personal Information for Password Cracking](#OMEN) by M. Durmuth (2013)
<a name = "Telepathwords"></a>[Telepathwords:Preventing Weak Passwords by Reading Users' Minds](#Telepathwords) by C. Herley (USENIX Security 2014)
...
#### [HERE](#REMARK) are Some Paper Remarks 
#### [HERE](#REMARK) are Initial Results
---
...
-----
####<a name="ChinesePass"></a> Review on __A Large-Scale Empirical Analysis of Chinese Web Passwords(2014 USENIX Security):__
Highlight:
